...
def get_words():
    words=[]
    with open(PUNGAN_ROOT_PATH + '/Pun_Generation/data/sample_130','r')as fr:
        for line in fr:
...
def prior_scores(words):
    ...
    ids_list=[]
    cnt=0
    with open(PUNGAN_ROOT_PATH + '/Pun_Generation/code/inference/final_vocab','r')as fv:
        for line in fv:
    ...
    with open(PUNGAN_ROOT_PATH + '/Pun_Generation/code/inference/tags_res_PMI','r')as fr:
        for line in fr:
            try:
                word_scores={}
